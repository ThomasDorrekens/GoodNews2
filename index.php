 ...
 */
function geneseControllerFunction()
{
 ...
 */
function livresControllerFunction()
{
 ...
 */
function conctactControllerFunction()
{
 ...
 */
function accueilControllerFunction()
{
...
switch($action) {
		case 'genese':
			$controller = geneseControllerFunction();
            break;
		case 'livres':
			$controller = livresControllerFunction();
            break;
		case 'contact':
			$controller = conctactControllerFunction();
            break;
		default: # Par défaut, le contrôleur de l'accueil est sélectionné
			$controller = accueilControllerFunction();
            break;
	}
